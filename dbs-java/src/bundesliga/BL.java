...
public class BL {
  ...
  public void createTables_dst() {
    ...
    sql[2]  = "CREATE TABLE IF NOT EXISTS `Spieler` ( `Id` int(11) NOT NULL, `Name` varchar(255) COLLATE utf8_unicode_ci NOT NULL, `Heimatland` varchar(255) COLLATE utf8_unicode_ci NOT NULL, PRIMARY KEY (`Id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;";
